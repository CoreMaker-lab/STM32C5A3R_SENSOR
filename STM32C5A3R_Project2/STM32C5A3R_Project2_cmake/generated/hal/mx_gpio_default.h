...
#define LED3_PORT                                       HAL_GPIOA
#define LED3_PIN                                        HAL_GPIO_PIN_8
#define LED3_INIT_STATE                                 HAL_GPIO_PIN_RESET
#define LED3_ACTIVE_STATE                               HAL_GPIO_PIN_SET
#define LED3_INACTIVE_STATE                             HAL_GPIO_PIN_RESET

/* Primary aliases for GPIO PB14 pin */
#define LED2_PORT                                       HAL_GPIOB
#define LED2_PIN                                        HAL_GPIO_PIN_14
#define LED2_INIT_STATE                                 HAL_GPIO_PIN_RESET
#define LED2_ACTIVE_STATE                               HAL_GPIO_PIN_SET
#define LED2_INACTIVE_STATE                             HAL_GPIO_PIN_RESET

/* Primary aliases for GPIO PB15 pin */
#define LED1_PORT                                       HAL_GPIOB
#define LED1_PIN                                        HAL_GPIO_PIN_15
#define LED1_INIT_STATE                                 HAL_GPIO_PIN_RESET
#define LED1_ACTIVE_STATE                               HAL_GPIO_PIN_SET
#define LED1_INACTIVE_STATE                             HAL_GPIO_PIN_RESET
